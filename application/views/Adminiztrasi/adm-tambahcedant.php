                ...
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								...
								<form action="<?php echo base_url('Admin/do_upload_cdn'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="row mb-3">
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="ins">Asuransi</label>
										  <div class="col-sm-10">
											<input class="form-control form-control-sm" id="ins" type="text" placeholder="asuransi" name="insurance" value="" />
										  </div>
										</div>
										...
										<div class="row mb-3">
										  ...
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="link">Link Asuransi</label>
										  <div class="col-sm-10">
											
											<input class="form-control form-control-sm" id="link" type="text" placeholder="url" name="url" value="" />
