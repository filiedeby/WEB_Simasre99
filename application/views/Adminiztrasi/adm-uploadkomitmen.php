              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								<?php foreach($c_komitmen as $u){ ?>
								<form action="<?php echo base_url('Admin/aksi_insertkomitmen'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										<input type="hidden" name="id" value="<?php echo $u->id ?>">
										<input type="hidden" name="bhs" value="<?php echo $u->bahasa ?>">
										<input type="hidden" name="judul" value="<?php echo $u->judul ?>">
										<input type="hidden" name="idkomit" value="<?php echo $u->idkomit ?>">
								
										<div class="row mb-3">
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm"></label>
										  <div class="col-sm-10">
										  
											 <img src="<?= base_url('assets/images/solution/').$u->gbr; ?>" alt="flow<?= $u->gbr; ?>" height="250" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar baru uk. 640 x 640 pixel">									 
										  </div>
										</div>
										...
										<div class="row mb-3">
										  ...
										  <div class="col-sm-10">
											...
											<input class="form-control" type="file" name="berkasdata" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar baru uk. 640 x 640 pixel" />
										...
										<div class="row mb-3">
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm">Link komitmen</label>
										  <div class="col-sm-10">
											
											<div class="min-vh-50">
											<textarea class="tinymce d-none" name="isi" id="default"><?php echo $u->isi ?></textarea>
											</div>
										  </div>
										</div>
