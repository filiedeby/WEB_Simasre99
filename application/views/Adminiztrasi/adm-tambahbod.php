                ...
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								...
								<form action="<?php echo base_url('Admin/simpanbod'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="row mb-3">
										  <label class="col-sm-3 col-form-label col-form-label-sm" for="validationCustom01">Nama Direksi / Team</label>
										  <div class="col-sm-9">
											<input class="form-control form-control-sm" id="validationCustom01" type="text" placeholder="Nama Lengkap" name="nama" value="" required="" />
										...
										<select id="titleDropdown" class="form-control" name="title" required="">
										   ...
										   <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm">Detail Title</label>
										  <div class="col-sm-4">
											<input class="form-control form-control-sm" id="colFormLabelSm" type="text" placeholder="(optional) masukan detail title jabatan" name="dettitle" value=""  />
										  </div>
										</div>
										...
										<div class="row mb-3">
										  <label class="col-sm-3 col-form-label col-form-label-sm" for="colFormLabelSm" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar uk. 1024 x 1024 pixel">Upload Gambar Jajaran Direksi & Team</label>
										  <div class="col-sm-9">

											<input class="form-control" type="file" name="berkasdata" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar uk. 1024 x 1024 pixel" required />
