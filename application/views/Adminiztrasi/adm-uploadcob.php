              ...
              <div class="row">
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								<?php foreach($c_cob as $u){ ?>
								<form action="<?php echo base_url('Admin/aksi_insertcob'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										<input type="hidden" name="id" value="<?php echo $u->id_cob ?>" readonly>
										<input type="hidden" name="bhs" value="<?php echo $u->bahasa ?>" readonly>
								
										
										
										<div class="row mb-3">
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm">Nama Produk</label>
										  <div class="col-sm-4">
											
											<input class="form-control form-control-sm" id="colFormLabelSm" type="text" placeholder="col-form-label-sm" name="title" value="<?php echo $u->produk ?>" />
										  </div>
										  
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm">Nama Url</label>
										  <div class="col-sm-4">
											
											<input class="form-control form-control-sm" id="colFormLabelSm" type="text" placeholder="col-form-label-sm" name="url" value="<?php echo $u->url ?>" readonly />
										  </div>
										</div>
										...
										<div class="row mb-3">
										  ...
										  <div class="col-sm-10">
											...
											<div class="min-vh-50">
											<textarea class="tinymce d-none" name="isi" id="default"><?php echo $u->detail ?></textarea>
											</div>
										  </div>
										</div>
										...
										<div class="row mb-3">
										 ...
										 <div class="col-sm-3 d-grid gap-2"> 
										   <a class="btn btn-outline-primary me-1 mb-1" type="icon" href="<?= base_url('Admin/mn3a'); ?>">Kembali</a>
										   </div>
