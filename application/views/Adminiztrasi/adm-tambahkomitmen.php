                ...
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								...
								<form action="<?php echo base_url('Admin/simpanbuletin'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="row mb-3">
										  <label class="col-sm-2 col-form-label col-form-label-sm" for="colFormLabelSm" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar uk. 300 x 451 pixel">Upload Gambar buletingram</label>
										  <div class="col-sm-10">

											<input class="form-control" type="file" name="berkasdata" data-bs-toggle="tooltip" data-bs-placement="top" title="Diharuskan upload gambar uk. 300 x 451 pixel" />
										...
										<div class="row mb-3">
										  ...
										  <div class="col-sm-10">
											<input class="form-control form-control-sm" id="colFormLabelSm" type="text" placeholder="link langsung buletin" name="url" value="" />
										  </div>
										</div>
