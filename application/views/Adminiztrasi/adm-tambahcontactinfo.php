                ...
                <div class="col-md-12 col-lg-12">
				  ...
				  <hr/>
					...
					<div class="container">
								...
								<form action="<?php echo base_url('Admin/simpancontactinfo'); ?>" method="post" enctype="multipart/form-data">
									<div class="row">
										...
										<label class="col-sm-2 col-form-label col-form-label-sm" for="exampleFormControlTextarea1">Address Info</label>
										<div class="col-sm-10">
	...
	<script>
		tinymce.init({
		 ...
		 'a11ychecker','advlist','advcode','advtable','autolink','checklist','export',
			   'lists','link','image','charcontactinfo','preview','anchor','searchreplace','visualblocks',
