<?php
	...
	class Adminiztrasi extends CI_Controller {
		...
		function aksi_login(){
			...
			if ($this->form_validation->run() == FALSE) {
				...
				redirect(base_url("Adminiztrasi"));
			} 
			else 
			{
				// Ambil data inputan			
						...
						if ($inisiasidtUser && $passLv == 'adm' && $passSt == 'y') {
							...
							if (validasiKatasandi($password, $passDb, $key)) {
								...
								else if  ($user_level=='adm'){
									$level = 'Administrator';	
								}
								else if  ($user_level=='edi'){
									$level = 'Editor';	
								}
								else {
									$level = 'User';
								...
								redirect(base_url("Adminiztrasi/beranda"));
							} else {
		...
		function logout(){
			...
			redirect(base_url('Adminiztrasi/index'));
		}
		
		function beranda(){
				if(isset($this->session->userdata['data_seslogin'])){
				$this->load->view('Adminiztrasi/adm-index');
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function mn1a(){
				...
				$this->load->view('Adminiztrasi/adm-head', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edithistory(){
			...
			$this->load->view('Adminiztrasi/adm-edithistory',$data);
		}	
		...
		function updatehistory(){
			...
			redirect(base_url('Adminiztrasi/mn1a'));
		}
...
///////////MENU HOME - flow claim ///////////
		...
		function flmn1c(){		
				...
				$this->load->view('Adminiztrasi/adm-flowclm', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		$data['c_clm'] = $this->M_admin->get_flowclmjudul();	
		$this->load->view('Adminiztrasi/adm-uploadclm', array('error' => ' ' ));
		}
	...
	function editclm(){
			...
			$this->load->view('Adminiztrasi/adm-uploadclm',$data);
	}	
	...
	public function aksi_insertfrmclm()
	{
		...
		$this->upload->initialize($config);
					...
					redirect(base_url('Adminiztrasi/mn1c'));
					}else {
		...
		function mn1b(){
				...
				$this->load->view('Adminiztrasi/adm-sliderx', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahsliderx(){
				...
				$this->load->view('Adminiztrasi/adm-tambahsliderx', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edit_statussliderx(){
			...
			$updatestatus = $this->M_admin->update_statussliderx($where,$data,'slider');
				...
				if (!isset($updatestatus)){
						...
						redirect(base_url('Adminiztrasi/mn1b'));
						}else {
						// $error = array('error' => $this->upload->display_errors());	
		...
		$this->load->view('Adminiztrasi/adm-uploadsliderx', array('error' => ' ' ));
		}
		...
		public function editsliderx(){
				...
				$this->load->view('Adminiztrasi/adm-uploadsliderx',$data);
		}	
...
///////////MENU HOME - iconpro ///////////
		...
		function mn1c(){
				...
				$this->load->view('Adminiztrasi/adm-iconpro', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahiconpro(){
				...
				$this->load->view('Adminiztrasi/adm-tambahiconpro', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		$this->load->view('Adminiztrasi/adm-uploadiconpro', array('error' => ' ' ));
		}
		...
		public function editiconpro(){
				...
				$this->load->view('Adminiztrasi/adm-uploadiconpro',$data);
		}	
...
///////////MENU - cob ///////////
		...
		function mn3a(){
				...
				$this->load->view('Adminiztrasi/adm-cob', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahcob(){
				...
				$this->load->view('Adminiztrasi/adm-tambahcob', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edit_statuscob(){
			...
			// die();
				...
				if (!isset($updatestatus)){
						...
						redirect(base_url('Adminiztrasi/mn3a'));
						}else {
						// $error = array('error' => $this->upload->display_errors());	
						$this->session->set_flashdata('message', '<div class="alert alert-danger border-2 d-flex align-items-center" role="alert"><div class="bg-danger me-3 icon-item"><span class="fas fa-exclamation text-white fs-3"></span></div>
						<p class="mb-0 flex-1">STATUS GAGAL di Update !!!</p><button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
		...
		$this->load->view('Adminiztrasi/adm-uploadcob', array('error' => ' ' ));
		}
		...
		public function editcob(){
				...
				$this->load->view('Adminiztrasi/adm-uploadcob',$data);
		}	
...
///////////MENU - cedant ///////////
		...
		function mn3b(){
				...
				$this->load->view('Adminiztrasi/adm-cedant', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
        ...
        if ( ! $this->upload->do_upload('logo')) {
			...
			redirect(base_url('Adminiztrasi/mn3b'));		
	...
	// =============================================ceedqant baru ============================================
		...
		function tambahreins(){
				...
				$this->load->view('Adminiztrasi/adm-tambahreins', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
        ...
        if ( ! $this->upload->do_upload('logo')) {
			...
			redirect(base_url('Adminiztrasi/mn3c'));		
	...
	public function edit_reins(){
		if(isset($this->session->userdata['data_seslogin'])){
			...
			$this->load->view('Adminiztrasi/adm-editedreins', $data);
		}
		else{
		redirect(base_url("Adminiztrasi/index"));
		}
		...
		function tambahcedant(){
				...
				$this->load->view('Adminiztrasi/adm-tambahcedant', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		public function editcedant(){
				...
				$this->load->view('Adminiztrasi/adm-uploadcedant',$data);
		}	
...
///////////MENU - reinsurance ///////////
		...
		function mn3c(){
				...
				$this->load->view('Adminiztrasi/adm-reinsurance', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahreinsurance(){
				...
				$this->load->view('Adminiztrasi/adm-tambahreinsurance', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		$this->load->view('Adminiztrasi/adm-uploadreinsurance', array('error' => ' ' ));
		}
		...
		public function editreinsurance(){
				...
				$this->load->view('Adminiztrasi/adm-uploadreinsurance',$data);
		}	
		...
		function mn4a(){
				...
				$this->load->view('Adminiztrasi/adm-visimisi', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahvisimisi(){
				...
				$this->load->view('Adminiztrasi/adm-tambahvisimisi', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edit_statusvisimisi(){
			...
			// die();
				...
				if (!isset($updatestatus)){
						...
						redirect(base_url('Adminiztrasi/mn4a'));
						}else {
						// $error = array('error' => $this->upload->display_errors());	
						$this->session->set_flashdata('message', '<div class="alert alert-danger border-2 d-flex align-items-center" role="alert"><div class="bg-danger me-3 icon-item"><span class="fas fa-exclamation text-white fs-3"></span></div>
						<p class="mb-0 flex-1">STATUS GAGAL di Update !!!</p><button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
		...
		$this->load->view('Adminiztrasi/adm-uploadvisimisi', array('error' => ' ' ));
		}
		...
		public function editvisimisi(){
				...
				$this->load->view('Adminiztrasi/adm-uploadvisimisi',$data);
		}	
		...
		function mn4b(){
				...
				$this->load->view('Adminiztrasi/adm-bod', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		if(isset($this->session->userdata['data_seslogin'])){
			...
			$this->load->view('Adminiztrasi/adm-tambahbod', $data);
			}
			else{
			redirect(base_url("Adminiztrasi/index"));
			}
		...
		$date 							= date('d F Y, h:i:s A');
			...
			if ($simpan > 0){
				...
				redirect(base_url('Adminiztrasi/mn4b'));
			}else {
		...
		$this->load->view('Adminiztrasi/adm-uploadbod', array('error' => ' ' ));
		}
		...
		public function editbod(){
				...
				$this->load->view('Adminiztrasi/adm-uploadbod',$data);
		}	
		...
		public function aksi_insertbod()
	{
		...
		function mn4f(){
				...
				$this->load->view('Adminiztrasi/adm-map', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahmap(){
				...
				$this->load->view('Adminiztrasi/adm-tambahmap', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edit_statusmap(){
			...
			$updatestatus = $this->M_admin->update_statusmap($where,$data,'map');
				...
				if (!isset($updatestatus)){
						...
						redirect(base_url('Adminiztrasi/mn4f'));
						}else {
						// $error = array('error' => $this->upload->display_errors());	
						$this->session->set_flashdata('message', '<div class="alert alert-danger border-2 d-flex align-items-center" role="alert"><div class="bg-danger me-3 icon-item"><span class="fas fa-exclamation text-white fs-3"></span></div>
						<p class="mb-0 flex-1">STATUS GAGAL di Update !!!</p><button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
		...
		$data['c_map'] = $this->M_admin->get_map();	
		$this->load->view('Adminiztrasi/adm-uploadmap', array('error' => ' ' ));
		}
		...
		public function editmap(){
				...
				$this->load->view('Adminiztrasi/adm-uploadmap',$data);
		}	
		...
		function mn4c(){
				...
				$this->load->view('Adminiztrasi/adm-activity', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		if(isset($this->session->userdata['data_seslogin'])){
				...
				$this->load->view('Adminiztrasi/adm-tambahactivity', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		public function simpanactivity(){
			if(isset($this->session->userdata['data_seslogin'])){	
				...
				if(!isset($updatecontactinfo)){
					...
					redirect(base_url('Adminiztrasi/mn4c'));
				}else {
		...
		public function editactivity(){
				...
				$this->load->view('Adminiztrasi/adm-uploadactivity',$data);
		}	
		...
		function mn4g(){
				...
				$this->load->view('Adminiztrasi/adm-contactinfo', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahcontactinfo(){
				...
				$this->load->view('Adminiztrasi/adm-tambahcontactinfo', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function edit_statuscontactinfo(){
			...
			$updatestatus = $this->M_admin->update_statuscontactinfo($where,$data,'contact_info');
				...
				if (!isset($updatestatus)){
						...
						redirect(base_url('Adminiztrasi/mn4g'));
						}else {
						// $error = array('error' => $this->upload->display_errors());	
						$this->session->set_flashdata('message', '<div class="alert alert-danger border-2 d-flex align-items-center" role="alert"><div class="bg-danger me-3 icon-item"><span class="fas fa-exclamation text-white fs-3"></span></div>
						<p class="mb-0 flex-1">STATUS GAGAL di Update !!!</p><button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
		...
		$data['c_contactinfo'] = $this->M_admin->get_contactinfo();	
		$this->load->view('Adminiztrasi/adm-uploadcontactinfo', array('error' => ' ' ));
		}
		...
		public function editcontactinfo(){
				...
				$this->load->view('Adminiztrasi/adm-uploadcontactinfo',$data);
		}	
		...
		function mn5a(){
				...
				$this->load->view('Adminiztrasi/adm-gallery', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		function tambahgallery(){
				...
				$this->load->view('Adminiztrasi/adm-tambahgallery', $data);
				}
				else{
				redirect(base_url("Adminiztrasi/index"));
				}
		...
		$config['file_name'] 			= $today.'_'.$e_nama;
			...
			$this->M_admin->insert_gallery($data,'gallery');
				...
				redirect(base_url('Adminiztrasi/mn5a'));
			}else {
		...
		$this->load->view('Adminiztrasi/adm-uploadgallery', array('error' => ' ' ));
		}
		...
		public function editgallery(){
				...
				$this->load->view('Adminiztrasi/adm-uploadgallery',$data);
		}	
